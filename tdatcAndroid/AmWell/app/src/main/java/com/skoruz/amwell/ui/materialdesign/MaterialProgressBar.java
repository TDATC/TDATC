...
public class MaterialProgressBar extends ProgressBar {
    ...
    public MaterialProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int color = a.getColor(R.styleable.MaterialProgressBar_color, res.getColor(R.color.primary_blue));
        ...
        this.indeterminateDrawable.setBackgroundColor(CIRCLE_BG_LIGHT);
        this.indeterminateDrawable.setAlpha(255);
        this.indeterminateDrawable.updateSizes(MaterialProgressDrawable.LARGE);
        setColor(color);
    }

    public void setColor(int color) {
        this.indeterminateDrawable.stop();
        this.indeterminateDrawable.setColorSchemeColors(color);
